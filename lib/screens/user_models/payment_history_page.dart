...
class HistoryPageee extends StatefulWidget {
  HistoryPageee({super.key, required this.userid});
  int? userid;

  @override
  State<HistoryPageee> createState() => _HistoryPageeeState();
}

class _HistoryPageeeState extends State<HistoryPageee> {
